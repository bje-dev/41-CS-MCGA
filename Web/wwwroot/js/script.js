...
async function calcularIntensidad() {
    ...
    try {
        const response = await fetch('http://localhost:5071/api/Acoustic/calculate-intensity', {
            method: 'POST',
            headers: {
...
async function calcularPotencia() {
    ...
    try {
        const response = await fetch('http://localhost:5071/api/Acoustic/calculate-power', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function calcularPotenciaPresion() {
    ...
    try {
        const response = await fetch('http://localhost:5071/api/Acoustic/calculate-power-with-pressure', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
